...
import pic2 from "../images/giphy.gif";
import { GlobalContext } from "../App";

function Swimcard() {
  const { swimming, deleteData, editData } = useContext(GlobalContext);
  return (
    <div>
        ...
        <div className="row">
          <div className="col-4">
            <div className="card" style={{ width: "18rem" }}>
              <img src={pic2} className="card-img-top" alt="no " />
              <div className="card-body">
                <h5 className="card-title text-center gum">Swimming</h5>
              </div>
            </div>
          </div>
          <div className="col-8">
